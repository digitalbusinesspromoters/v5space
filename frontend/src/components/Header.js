      ...
      <div className='main-header-right row m-0'>
        ...
        <div className='nav-right col pull-right right-menu p-0'>
          <ul className='nav-menus'>
                ...
                <ul className='m-t-5'>
                  <li className='add-to-bookmark'>
                    <svg
                      ...
                      strokeLinecap='round'
                      strokeLinejoin='round'
                      className='feather feather-inbox bookmark-icon'
                    >
                  ...
                  <li className='add-to-bookmark'>
                    <svg
                      ...
                      strokeLinecap='round'
                      strokeLinejoin='round'
                      className='feather feather-message-square bookmark-icon'
                    >
                  ...
                  <li className='add-to-bookmark'>
                    <svg
                      ...
                      strokeLinecap='round'
                      strokeLinejoin='round'
                      className='feather feather-command bookmark-icon'
                    >
                  ...
                  <li className='add-to-bookmark'>
                    <svg
                      ...
                      strokeLinecap='round'
                      strokeLinejoin='round'
                      className='feather feather-airplay bookmark-icon'
                    >
            ...
            <div style={{ position: "fixed", right: "5rem" }}>
              <li className='onhover-dropdown' style={{ marginRight: "1rem" }}>
